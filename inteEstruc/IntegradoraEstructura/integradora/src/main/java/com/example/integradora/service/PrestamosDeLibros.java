...
public class PrestamosDeLibros {
    ...
    public PrestamosDeLibros(GestionDeLibros gestionDeLibros) {
    ...
    public String nuevoPrestamo(int idlibro, int idUsuario) {
        Libro libro = gestionDeLibros.buscarLibroId(idlibro);

        if (libro == null) {

            return "Error: Libro con ID " + idlibro + " no encontrado o dado de baja.";
        }
        ...
        if (libro.getCopiasDisponibles() > 0) {
            ...
            return "Préstamo creado con exito. ID: " + nuevoPrestamo.getId();
   ...
   public SinglyLinkedListP prestamosUsuarioId(int usuarioId){
    ...
    public String devolverLibro(int prestamoId) {
        ...
        Libro libro = gestionDeLibros.buscarLibroId(libroId);
        ...
        switch (tipo) {
            ...
            case "CREATE_LOAN":
                ...
                if (removido) {
                    ...
                    Libro libro = gestionDeLibros.buscarLibroId(relacionId);
                    libro.setCopiasDisponibles(libro.getCopiasDisponibles() + 1);
            ...
            case "ADD_TO_WAITLIST":
                ...
                Libro libro = gestionDeLibros.buscarLibroId(primerId);
