...
public class LibrosController {
    ...
    @PostMapping
    public ResponseEntity<RespuestaRequest> agregarLibros(@RequestBody Libro nuevoLibro) { //enlaza el cuerpo completo de la solicitud
    ...
    @GetMapping("/{id}")
    public ResponseEntity<RespuestaRequest> BuscarLibroId(@PathVariable int id) {//extrae el valor url
    ...
    @PutMapping("/{id}")
    public ResponseEntity<RespuestaRequest> ActualizarLibroID(@PathVariable int id, @RequestBody LibroRequest libroactualizado) { //enlazar el cuerpo completo de la solicitud
    ...
    public ResponseEntity<RespuestaRequest> ActualizarLibroEstado(@PathVariable int id, @RequestParam boolean estado) {//extrae el valor url
    ...
    @GetMapping("/search")
    public ResponseEntity<RespuestaRequest> busquedaLibroTitulo(@RequestParam String titulo) {//pasar datos pasdos a parametros consulta
