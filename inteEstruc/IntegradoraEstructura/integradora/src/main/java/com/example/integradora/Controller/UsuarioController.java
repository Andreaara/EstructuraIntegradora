...
public class UsuarioController {
    ...
    @PostMapping
    public ResponseEntity<RespuestaRequest> crearUsuario(@RequestBody Usuario nuevoUsuario) { //enlazar el cuerpo completo de la solicitud
    ...
    @GetMapping("/{id}")
    public ResponseEntity<RespuestaRequest> BuscarUsuario(@PathVariable int id) {//extrae el valor url
