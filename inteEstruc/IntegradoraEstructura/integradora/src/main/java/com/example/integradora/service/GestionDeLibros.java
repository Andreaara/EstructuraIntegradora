...
public  GestionDeLibros(){
    Libro l1 = new Libro(1, "El principito", 2,1,true, new ArrayQueue<>());
    Libro l2 = new Libro(2, "Don Quijote", 3,3,false, new ArrayQueue<>());
    Libro l3 = new Libro(3, "Caperucita roja", 2,1,true, new ArrayQueue<>());
    ...
    public Libro agregarLibros(Libro nuevoLibro){
        ...
        nuevoLibro.setReservas(new ArrayQueue());
